...
<button type="button" class="close" data-dismiss="alert" aria-label="Close">
   ...
   <a class="btn btn-primary btn-sm " href="{{url('inputsuratmsk')}}">+ Surat Masuk</a>
          @endif
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <th scope="col">Action</th>
                      ...
                      $no = 1;
                  @endphp
                <tbody>@foreach ($suratmsk as $item)
                  <tr>     
                    <th scope="row">{{$no ++}}</th>
                    ...
                    <td>{{$item->nosurat}}</td>
                    <td>
                      <a class="btn btn-primary bi bi-collection" href="{{ asset('uploads/' . $item->file)}}"> Lihat</a>
                    </td>
                  </tr>
               @endforeach
                </tbody>
