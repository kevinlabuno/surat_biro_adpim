            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2"><center>
                 <img src="assets/img/logopb.png" width="100" height="100">
                 {{-- <p >Silakan Login</p></center> --}}
                  </div>
...
<button type="button" class="close" data-dismiss="alert" aria-label="Close">
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
   ...
   @endif
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Belum punya akun? <a href="{{url('register')}}">Buat akun baru</a></p>
                    </div>
                  </form>
              ...
              <div class="credits">
                ...
                {{-- Designed by <a href="https://github.com/kakiyowoo">kakiyowoo</a> --}}
              </div>
